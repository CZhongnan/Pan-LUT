...
save_dir_fullWV2 = './result/fullWV2/'
save_dir_fullWV2_rgb = './result/fullWV2_rgb/'
test_config_path = './configs/'
list_algorithm = [
               {'algorithm':'model','model':'D:\myproject\Pan-LUT\checkpoint\wv2.ckpt',
                  'test_config_path':test_config_path+'Train_'+'DIRFL'+'.json'}
                 ]
dataset_selceted = ['WV2']
if __name__ == '__main__':
    ...
    for list in list_algorithm:
        ...
        cfg['test5']['model']= list['model'];cfg['test5']['test_config_path']= list['test_config_path']
        cfg['test5']['save_dir'] = save_dir_fullWV2+list['algorithm']+'/'
        cfg['test5']['save_dir_rgb'] = save_dir_fullWV2_rgb+list['algorithm']+'/'
        cfg['test5']['save_dir_rgb'] = save_dir_fullWV2_rgb+'/'
        ...
        if 'GF2' in dataset_selceted:
          method = cfg['algorithm'];data_type = cfg['test']['datatype'];name = list['model']
        ...
        if 'WV2' in dataset_selceted:
          method = cfg['algorithm'];data_type = cfg['test2']['datatype'];name = list['model']
          print(f'+++++++++++++++++++++++++++++++++{method} testting : {data_type}+++++++++++++++++++++++++++++++++')
          temp = cfg['test']
          cfg['test'] = cfg['test2']
          solver = Testsolver1(cfg)
       ...
       # WV3
        if 'WV3' in dataset_selceted:
          method = cfg['algorithm'];data_type = cfg['test3']['datatype'];name = list['model']
          print(f'+++++++++++++++++++++++++++++++++{method} testting : {data_type}+++++++++++++++++++++++++++++++++')
          temp = cfg['test']
          cfg['test'] = cfg['test3']
          solver = Testsolver1(cfg)
        ...
        if 'fullGF2' in dataset_selceted:
          method = cfg['algorithm'];data_type = cfg['test4']['datatype'];name = list['model']
          print(f'+++++++++++++++++++++++++++++++++{method} testting : {data_type}+++++++++++++++++++++++++++++++++')
          temp = cfg['test']
          cfg['test'] = cfg['test4']
          solver = Testsolver1(cfg)
        ...
        if 'fullWV2' in dataset_selceted:
          method = cfg['algorithm'];data_type = cfg['test5']['datatype']
          print(f'+++++++++++++++++++++++++++++++++{method} testting : {data_type}+++++++++++++++++++++++++++++++++')
          temp = cfg['test']
          cfg['test'] = cfg['test5']
          solver = Testsolver1(cfg)
          solver.run()
          evaluate_metric(cfg)
          cfg['test5']['save_dir'] = cfg['test5']['save_dir_rgb']
          solver = Testsolver_o(cfg)
          solver.run()
          cfg['test'] = temp
          print(f'+++++++++++++++++++++++++++++++++{method} testting : {data_type}+++++++++++++++++++++++++++++++++\n')

...
def evaluate_metric(cfg1):
    ...
    path_ms = f"/home/caizn/Awaresome-pansharpening/data/Data/{datatype}_data/{test_data}/ms"
    path_pan = f"/home/caizn/Awaresome-pansharpening/data/Data/{datatype}_data/{test_data}/pan"
    # path_ms = f"/home/caizn/Awaresome-pansharpening/data/Data/{datatype}/{test_data}/ms"
    # path_pan = f"/home/caizn/Awaresome-pansharpening/data/Data/{datatype}/{test_data}/pan"
    path_predict =f"./result/{datatype}/{method}/test"
    # path_predict =f"/home/caizn/DIRFL/imagetest/pnn_WV2/test"
    # print(datatype)
    list_name = []
    ...
    for file_name_i in list_name:
        ...
        if datatype == 'fullGF2' or datatype == 'fullWV2':
        ...
        #print(gt.shape)
        if datatype != 'fullGF2' and datatype != 'fullWV2':
